...
public class ZitiShimManager {
   ...
   */  
  public static BaseZitiDriverShim registerShim(String urlPattern, String driverClassName, EnumSet<ZitiFeature> ztFeatures) throws ReflectiveOperationException {
    log.fine(() -> String.format("Registring shim, URL: %s, driver: %s, features: %s", urlPattern, driverClassName, ztFeatures));
    BaseZitiDriverShim shim = new BaseZitiDriverShim(urlPattern, driverClassName, ztFeatures);
