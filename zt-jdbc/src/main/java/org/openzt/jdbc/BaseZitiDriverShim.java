...
public class BaseZitiDriverShim {
  ...
  protected final EnumSet<ZitiFeature> ztFeatures;

  public BaseZitiDriverShim(String urlPattern, String driverClassName, EnumSet<ZitiFeature> ztFeatures) throws ReflectiveOperationException {
    this.urlPattern = Pattern.compile(urlPattern);
    this.driverClass = driverClassName;
    this.ztFeatures = ztFeatures;
