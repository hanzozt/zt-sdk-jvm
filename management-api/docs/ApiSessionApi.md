...
|------------- | ------------- | -------------|
| [**deleteAPISessions**](ApiSessionApi.md#deleteAPISessions) | **DELETE** /api-sessions/{id} | Deletes an API Sessions |
| [**deleteAPISessionsWithHttpInfo**](ApiSessionApi.md#deleteAPISessionsWithHttpInfo) | **DELETE** /api-sessions/{id} | Deletes an API Sessions |
| [**detailAPISessions**](ApiSessionApi.md#detailAPISessions) | **GET** /api-sessions/{id} | Retrieves a single API Session |
| [**detailAPISessionsWithHttpInfo**](ApiSessionApi.md#detailAPISessionsWithHttpInfo) | **GET** /api-sessions/{id} | Retrieves a single API Session |
| [**listAPISessions**](ApiSessionApi.md#listAPISessions) | **GET** /api-sessions | List active API sessions |
| [**listAPISessionsWithHttpInfo**](ApiSessionApi.md#listAPISessionsWithHttpInfo) | **GET** /api-sessions | List active API sessions |



## deleteAPISessions

> CompletableFuture<Empty> deleteAPISessions(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The id of the requested resource
        try {
            CompletableFuture<ApiResponse<Empty>> response = apiInstance.deleteAPISessionsWithHttpInfo(id);
...
> CompletableFuture<DetailApiSessionEnvelope> detailAPISessions(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The id of the requested resource
        try {
            CompletableFuture<DetailApiSessionEnvelope> result = apiInstance.detailAPISessions(id);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling ApiSessionApi#detailAPISessions");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
CompletableFuture<[**DetailApiSessionEnvelope**](DetailApiSessionEnvelope.md)>
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Retrieves a singular API Session by id |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **401** | The supplied session does not have the correct access rights to request this resource |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **404** | The requested resource does not exist |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **429** | The resource requested is rate limited and the rate limit has been exceeded |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **503** | The request could not be completed due to the server being busy or in a temporarily bad state |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The id of the requested resource
        try {
            CompletableFuture<ApiResponse<DetailApiSessionEnvelope>> response = apiInstance.detailAPISessionsWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**DetailApiSessionEnvelope**](DetailApiSessionEnvelope.md)>>
...
> CompletableFuture<ListApiSessionsEnvelope> listAPISessions(limit, offset, filter)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<ListApiSessionsEnvelope> result = apiInstance.listAPISessions(limit, offset, filter);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling ApiSessionApi#listAPISessions");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
CompletableFuture<[**ListApiSessionsEnvelope**](ListApiSessionsEnvelope.md)>
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | A list of active API Sessions |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
...
public class Example {
    public static void main(String[] args) {
        ...
        String filter = "filter_example"; // String | 
        try {
            CompletableFuture<ApiResponse<ListApiSessionsEnvelope>> response = apiInstance.listAPISessionsWithHttpInfo(limit, offset, filter);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**ListApiSessionsEnvelope**](ListApiSessionsEnvelope.md)>>
