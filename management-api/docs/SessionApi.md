...
| [**detailSessionRoutePath**](SessionApi.md#detailSessionRoutePath) | **GET** /sessions/{id}/route-path | Retrieves a single session&#39;s router path |
| [**detailSessionRoutePathWithHttpInfo**](SessionApi.md#detailSessionRoutePathWithHttpInfo) | **GET** /sessions/{id}/route-path | Retrieves a single session&#39;s router path |
...
import org.openziti.management.api.SessionApi;
...
> CompletableFuture<DetailSessionManagementEnvelope> detailSession(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The id of the requested resource
        try {
            CompletableFuture<DetailSessionManagementEnvelope> result = apiInstance.detailSession(id);
            System.out.println(result.get());
        } catch (ApiException e) {
...
CompletableFuture<[**DetailSessionManagementEnvelope**](DetailSessionManagementEnvelope.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The id of the requested resource
        try {
            CompletableFuture<ApiResponse<DetailSessionManagementEnvelope>> response = apiInstance.detailSessionWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**DetailSessionManagementEnvelope**](DetailSessionManagementEnvelope.md)>>
...
> CompletableFuture<DetailSessionRoutePathEnvelope> detailSessionRoutePath(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The id of the requested resource
        try {
            CompletableFuture<DetailSessionRoutePathEnvelope> result = apiInstance.detailSessionRoutePath(id);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling SessionApi#detailSessionRoutePath");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
CompletableFuture<[**DetailSessionRoutePathEnvelope**](DetailSessionRoutePathEnvelope.md)>
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | A single session&#39;s route path |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **401** | The supplied session does not have the correct access rights to request this resource |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **404** | The requested resource does not exist |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **429** | The resource requested is rate limited and the rate limit has been exceeded |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
| **503** | The request could not be completed due to the server being busy or in a temporarily bad state |  * WWW-Authenticate - Denotes different type of security token related information <br>  |
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | The id of the requested resource
        try {
            CompletableFuture<ApiResponse<DetailSessionRoutePathEnvelope>> response = apiInstance.detailSessionRoutePathWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**DetailSessionRoutePathEnvelope**](DetailSessionRoutePathEnvelope.md)>>
...
> CompletableFuture<ListSessionsManagementEnvelope> listSessions(limit, offset, filter)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<ListSessionsManagementEnvelope> result = apiInstance.listSessions(limit, offset, filter);
            System.out.println(result.get());
        } catch (ApiException e) {
...
CompletableFuture<[**ListSessionsManagementEnvelope**](ListSessionsManagementEnvelope.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        String filter = "filter_example"; // String | 
        try {
            CompletableFuture<ApiResponse<ListSessionsManagementEnvelope>> response = apiInstance.listSessionsWithHttpInfo(limit, offset, filter);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**ListSessionsManagementEnvelope**](ListSessionsManagementEnvelope.md)>>
