...
public class AuthPolicySecondaryPatch {
    ...
    @JsonProperty(value = JSON_PROPERTY_REQUIRE_EXT_JWT_SIGNER, required = false)
    ...
    @JsonProperty(value = JSON_PROPERTY_REQUIRE_TOTP, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        if (getRequireTotp() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getRequireTotp()))));
        }
