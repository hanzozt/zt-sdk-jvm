...
public class PostureDataMfa {
    ...
    @JsonProperty(value = JSON_PROPERTY_API_SESSION_ID, required = true)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_PASSED_AT, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_PASSED_MFA, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_PASSED_ON_UNLOCK, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_PASSED_ON_WAKE, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
        ...
        if (getPassedAt() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getPassedAt()))));
        }
