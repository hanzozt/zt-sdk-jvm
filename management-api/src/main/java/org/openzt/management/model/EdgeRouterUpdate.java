...
@JsonPropertyOrder({
    EdgeRouterUpdate.JSON_PROPERTY_APP_DATA,
    EdgeRouterUpdate.JSON_PROPERTY_COST,
    EdgeRouterUpdate.JSON_PROPERTY_DISABLED,
    EdgeRouterUpdate.JSON_PROPERTY_IS_TUNNELER_ENABLED,
    EdgeRouterUpdate.JSON_PROPERTY_NAME,
    EdgeRouterUpdate.JSON_PROPERTY_NO_TRAVERSAL,
    EdgeRouterUpdate.JSON_PROPERTY_ROLE_ATTRIBUTES,
    EdgeRouterUpdate.JSON_PROPERTY_TAGS
})
...
public class EdgeRouterUpdate {
    ...
    public EdgeRouterUpdate() {}

    public EdgeRouterUpdate appData(@javax.annotation.Nullable Tags appData) {
    ...
    public EdgeRouterUpdate cost(@javax.annotation.Nullable Integer cost) {
    ...
    public EdgeRouterUpdate disabled(@javax.annotation.Nullable Boolean disabled) {
    ...
    public EdgeRouterUpdate isTunnelerEnabled(
            @javax.annotation.Nullable Boolean isTunnelerEnabled) {
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_IS_TUNNELER_ENABLED, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public EdgeRouterUpdate name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public EdgeRouterUpdate noTraversal(@javax.annotation.Nullable Boolean noTraversal) {
    ...
    @JsonProperty(value = JSON_PROPERTY_NO_TRAVERSAL, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public EdgeRouterUpdate roleAttributes(@javax.annotation.Nullable List<String> roleAttributes) {
        this.roleAttributes = JsonNullable.<List<String>>of(roleAttributes);
        return this;
    }

    public EdgeRouterUpdate addRoleAttributesItem(String roleAttributesItem) {
    ...
    public EdgeRouterUpdate tags(@javax.annotation.Nullable Tags tags) {
        this.tags = tags;
        return this;
    }
    ...
    /** Return true if this edgeRouterUpdate object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        EdgeRouterUpdate edgeRouterUpdate = (EdgeRouterUpdate) o;
        return Objects.equals(this.appData, edgeRouterUpdate.appData)
                && equalsNullable(this.cost, edgeRouterUpdate.cost)
                && equalsNullable(this.disabled, edgeRouterUpdate.disabled)
                && Objects.equals(this.isTunnelerEnabled, edgeRouterUpdate.isTunnelerEnabled)
                && Objects.equals(this.name, edgeRouterUpdate.name)
                && equalsNullable(this.noTraversal, edgeRouterUpdate.noTraversal)
                && equalsNullable(this.roleAttributes, edgeRouterUpdate.roleAttributes)
                && Objects.equals(this.tags, edgeRouterUpdate.tags);
    }
    ...
    public String toString() {
        ...
        sb.append("class EdgeRouterUpdate {\n");
