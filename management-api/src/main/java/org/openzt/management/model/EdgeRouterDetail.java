...
@JsonPropertyOrder({
    ...
    EdgeRouterDetail.JSON_PROPERTY_INTERFACES,
...
public class EdgeRouterDetail {
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_SUPPORTED_PROTOCOLS, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_SYNC_STATUS, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    ...
    @JsonProperty(value = JSON_PROPERTY_ENROLLMENT_CREATED_AT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_ENROLLMENT_EXPIRES_AT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_ENROLLMENT_JWT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_ENROLLMENT_TOKEN, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public EdgeRouterDetail interfaces(@javax.annotation.Nullable List<ModelInterface> interfaces) {
        this.interfaces = interfaces;
        return this;
    }

    public EdgeRouterDetail addInterfacesItem(ModelInterface interfacesItem) {
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_IS_TUNNELER_ENABLED, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_IS_VERIFIED, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    ...
    @JsonProperty(value = JSON_PROPERTY_UNVERIFIED_CERT_PEM, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_UNVERIFIED_FINGERPRINT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.links, edgeRouterDetail.links)
                ...
                && Objects.equals(this.interfaces, edgeRouterDetail.interfaces)
        ...
        if (getHostname() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getHostname()))));
        }
        ...
        if (getEnrollmentJwt() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getEnrollmentJwt()))));
        }
        ...
        if (getEnrollmentToken() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getEnrollmentToken()))));
        }
        ...
        if (getUnverifiedCertPem() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getUnverifiedCertPem()))));
        }
