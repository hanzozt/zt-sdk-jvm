...
public class SessionManagementDetail {
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_API_SESSION, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_EDGE_ROUTERS, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_SERVICE_POLICIES, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
