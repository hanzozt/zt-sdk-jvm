...
public class AuthPolicyPrimaryUpdbPatch {
    ...
    @JsonProperty(value = JSON_PROPERTY_LOCKOUT_DURATION_MINUTES, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_MIN_PASSWORD_LENGTH, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_REQUIRE_MIXED_CASE, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_REQUIRE_NUMBER_CHAR, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_REQUIRE_SPECIAL_CHAR, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
