...
/** RouterUpdate */
@JsonPropertyOrder({
    RouterUpdate.JSON_PROPERTY_COST,
    RouterUpdate.JSON_PROPERTY_DISABLED,
    RouterUpdate.JSON_PROPERTY_NAME,
    RouterUpdate.JSON_PROPERTY_NO_TRAVERSAL,
    RouterUpdate.JSON_PROPERTY_TAGS
})
...
public class RouterUpdate {
    ...
    public RouterUpdate cost(@javax.annotation.Nullable Integer cost) {
    ...
    public RouterUpdate disabled(@javax.annotation.Nullable Boolean disabled) {
    ...
    public RouterUpdate name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public RouterUpdate noTraversal(@javax.annotation.Nullable Boolean noTraversal) {
    ...
    public RouterUpdate tags(@javax.annotation.Nullable Tags tags) {
        this.tags = tags;
        return this;
    }
    ...
    /** Return true if this routerUpdate object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        RouterUpdate routerUpdate = (RouterUpdate) o;
        return equalsNullable(this.cost, routerUpdate.cost)
                && equalsNullable(this.disabled, routerUpdate.disabled)
                && Objects.equals(this.name, routerUpdate.name)
                && equalsNullable(this.noTraversal, routerUpdate.noTraversal)
                && Objects.equals(this.tags, routerUpdate.tags);
    }
