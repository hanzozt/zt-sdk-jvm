...
public class VersionInfo {
    ...
    @JsonProperty(value = JSON_PROPERTY_ARCH, required = true)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_BUILD_DATE, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
        ...
        if (getBuildDate() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getBuildDate()))));
        }
        ...
        if (getRevision() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getRevision()))));
        }
