...
public class AuthPolicyPrimary {
    ...
    @JsonProperty(value = JSON_PROPERTY_CERT, required = true)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_EXT_JWT, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_UPDB, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
