...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        updateBaseUri("https://demo.ziti.dev/edge/client/v1");
        interceptor = null;
        readTimeout = null;
        connectTimeout = null;
    ...
    public ApiClient(HttpClient.Builder builder, ObjectMapper mapper, String baseUri) {
        ...
        this.mapper = mapper;
        updateBaseUri(baseUri != null ? baseUri : "https://demo.ziti.dev/edge/client/v1");
        interceptor = null;
        readTimeout = null;
        connectTimeout = null;
        responseInterceptor = null;
    ...
    /**
     * Returns the response body InputStream, transparently decoding gzip-compressed payloads when
     * the server sets {@code Content-Encoding: gzip}.
     *
     ...
     */
    public static InputStream getResponseBody(HttpResponse<InputStream> response)
            throws IOException {
        if (response == null) {
            return null;
        }
