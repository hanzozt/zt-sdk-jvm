...
import org.hanzozt.edge.model.CurrentIdentityDetailEnvelope;
...
import org.hanzozt.edge.model.ListCurrentIdentityEdgeRoutersEnvelope;
...
public class CurrentIdentityApi {
    ...
    public CompletableFuture<CurrentIdentityDetailEnvelope> getCurrentIdentity(
            Map<String, String> headers) throws ApiException {
        try {
            return getCurrentIdentityWithHttpInfo(headers).thenApply(ApiResponse::getData);
        } catch (ApiException e) {
            return CompletableFuture.failedFuture(e);
        }
    }
    ...
    public CompletableFuture<ApiResponse<CurrentIdentityDetailEnvelope>>
        ...
        return getCurrentIdentityWithHttpInfo(null);
    }
     ...
     */
    public CompletableFuture<ApiResponse<CurrentIdentityDetailEnvelope>>
            getCurrentIdentityWithHttpInfo(Map<String, String> headers) throws ApiException {
        try {
            HttpRequest.Builder localVarRequestBuilder = getCurrentIdentityRequestBuilder(headers);
            return memberVarHttpClient
                    .sendAsync(
                            localVarRequestBuilder.build(),
                            HttpResponse.BodyHandlers.ofInputStream())
                            ...
                            localVarResponse -> {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        String responseBody =
                                                new String(localVarResponseBody.readAllBytes());
                                        CurrentIdentityDetailEnvelope responseValue =
                                                responseBody.isBlank()
                                                        ? null
                                                        : memberVarObjectMapper.readValue(
                                                                responseBody,
    ...
    private HttpRequest.Builder getCurrentIdentityRequestBuilder(Map<String, String> headers)
            throws ApiException {
    ...
    public CompletableFuture<ListCurrentIdentityEdgeRoutersEnvelope> getCurrentIdentityEdgeRouters()
            throws ApiException {
        return getCurrentIdentityEdgeRouters(null);
    }
    ...
    public CompletableFuture<ListCurrentIdentityEdgeRoutersEnvelope> getCurrentIdentityEdgeRouters(
            Map<String, String> headers) throws ApiException {
        try {
            return getCurrentIdentityEdgeRoutersWithHttpInfo(headers)
                    .thenApply(ApiResponse::getData);
        } catch (ApiException e) {
            return CompletableFuture.failedFuture(e);
        }
    ...
    public CompletableFuture<ApiResponse<ListCurrentIdentityEdgeRoutersEnvelope>>
        ...
        return getCurrentIdentityEdgeRoutersWithHttpInfo(null);
    }
     ...
     */
    public CompletableFuture<ApiResponse<ListCurrentIdentityEdgeRoutersEnvelope>>
            getCurrentIdentityEdgeRoutersWithHttpInfo(Map<String, String> headers)
                    throws ApiException {
        try {
            HttpRequest.Builder localVarRequestBuilder =
                    getCurrentIdentityEdgeRoutersRequestBuilder(headers);
            return memberVarHttpClient
                    .sendAsync(
                            localVarRequestBuilder.build(),
                            HttpResponse.BodyHandlers.ofInputStream())
                            ...
                            localVarResponse -> {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        String responseBody =
                                                new String(localVarResponseBody.readAllBytes());
                                        ListCurrentIdentityEdgeRoutersEnvelope responseValue =
                                                responseBody.isBlank()
                                                        ? null
                                                        : memberVarObjectMapper.readValue(
                                                                responseBody,
    ...
    private HttpRequest.Builder getCurrentIdentityEdgeRoutersRequestBuilder(
            Map<String, String> headers) throws ApiException {
