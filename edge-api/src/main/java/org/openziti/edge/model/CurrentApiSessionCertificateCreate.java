...
public class CurrentApiSessionCertificateCreate {
    ...
    @javax.annotation.Nonnull private String csr;

    public CurrentApiSessionCertificateCreate() {}

    public CurrentApiSessionCertificateCreate csr(@javax.annotation.Nonnull String csr) {
        this.csr = csr;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_CSR, required = true)
