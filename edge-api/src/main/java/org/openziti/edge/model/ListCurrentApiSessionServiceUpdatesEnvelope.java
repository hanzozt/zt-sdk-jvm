...
public class ListCurrentApiSessionServiceUpdatesEnvelope {
    ...
    @javax.annotation.Nonnull private CurrentApiSessionServiceUpdateList data;
    ...
    public ListCurrentApiSessionServiceUpdatesEnvelope data(
            @javax.annotation.Nonnull CurrentApiSessionServiceUpdateList data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setData(@javax.annotation.Nonnull CurrentApiSessionServiceUpdateList data) {
        this.data = data;
    }

    public ListCurrentApiSessionServiceUpdatesEnvelope meta(@javax.annotation.Nonnull Meta meta) {
        this.meta = meta;
        return this;
    }
