...
public class PostureResponseEndpointStateCreate extends PostureResponseCreate {
    ...
    @JsonProperty(value = JSON_PROPERTY_UNLOCKED, required = false)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_WOKEN, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        if (getUnlocked() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getUnlocked()))));
        }
        ...
        if (getWoken() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getWoken()))));
        }
