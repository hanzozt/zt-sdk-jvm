...
public class CurrentApiSessionCertificateDetail {
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_VALID_TO, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
        ...
        if (getCertificate() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getCertificate()))));
        }
        ...
        if (getValidFrom() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getValidFrom()))));
        }
        ...
        if (getValidTo() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getValidTo()))));
        }
