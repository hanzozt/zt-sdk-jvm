...
@JsonPropertyOrder({
    ...
    CurrentApiSessionDetail.JSON_PROPERTY_IMPROPER_CLIENT_CERT_CHAIN,
    CurrentApiSessionDetail.JSON_PROPERTY_IP_ADDRESS,
    CurrentApiSessionDetail.JSON_PROPERTY_IS_CERT_EXTEND_REQUESTED,
    CurrentApiSessionDetail.JSON_PROPERTY_IS_CERT_EXTENDABLE,
    CurrentApiSessionDetail.JSON_PROPERTY_IS_CERT_KEY_ROLL_REQUESTED,
...
public class CurrentApiSessionDetail {
    ...
    public static final String JSON_PROPERTY_IMPROPER_CLIENT_CERT_CHAIN = "improperClientCertChain";
    @javax.annotation.Nullable private Boolean improperClientCertChain;

    public static final String JSON_PROPERTY_IP_ADDRESS = "ipAddress";
    @javax.annotation.Nonnull private String ipAddress;

    public static final String JSON_PROPERTY_IS_CERT_EXTEND_REQUESTED = "isCertExtendRequested";
    @javax.annotation.Nullable private Boolean isCertExtendRequested;
    ...
    public static final String JSON_PROPERTY_IS_CERT_KEY_ROLL_REQUESTED = "isCertKeyRollRequested";
    @javax.annotation.Nullable private Boolean isCertKeyRollRequested;
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_AUTH_QUERIES, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_AUTHENTICATOR_ID, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_CACHED_LAST_ACTIVITY_AT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_CONFIG_TYPES, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    ...
    public CurrentApiSessionDetail improperClientCertChain(
            @javax.annotation.Nullable Boolean improperClientCertChain) {
        this.improperClientCertChain = improperClientCertChain;
        return this;
    }

    /**
     * Get improperClientCertChain
     *
     * @return improperClientCertChain
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_IMPROPER_CLIENT_CERT_CHAIN, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public Boolean getImproperClientCertChain() {
        return improperClientCertChain;
    }

    @JsonProperty(value = JSON_PROPERTY_IMPROPER_CLIENT_CERT_CHAIN, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setImproperClientCertChain(
            @javax.annotation.Nullable Boolean improperClientCertChain) {
        this.improperClientCertChain = improperClientCertChain;
    }
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_IP_ADDRESS, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    ...
    public CurrentApiSessionDetail isCertExtendRequested(
            @javax.annotation.Nullable Boolean isCertExtendRequested) {
        this.isCertExtendRequested = isCertExtendRequested;
        return this;
    }

    /**
     * Get isCertExtendRequested
     *
     * @return isCertExtendRequested
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_IS_CERT_EXTEND_REQUESTED, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public Boolean getIsCertExtendRequested() {
        return isCertExtendRequested;
    }

    @JsonProperty(value = JSON_PROPERTY_IS_CERT_EXTEND_REQUESTED, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setIsCertExtendRequested(@javax.annotation.Nullable Boolean isCertExtendRequested) {
        this.isCertExtendRequested = isCertExtendRequested;
    }
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_IS_CERT_EXTENDABLE, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    ...
    public CurrentApiSessionDetail isCertKeyRollRequested(
            @javax.annotation.Nullable Boolean isCertKeyRollRequested) {
        this.isCertKeyRollRequested = isCertKeyRollRequested;
        return this;
    }

    /**
     * Get isCertKeyRollRequested
     *
     * @return isCertKeyRollRequested
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_IS_CERT_KEY_ROLL_REQUESTED, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public Boolean getIsCertKeyRollRequested() {
        return isCertKeyRollRequested;
    }

    @JsonProperty(value = JSON_PROPERTY_IS_CERT_KEY_ROLL_REQUESTED, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setIsCertKeyRollRequested(
            @javax.annotation.Nullable Boolean isCertKeyRollRequested) {
        this.isCertKeyRollRequested = isCertKeyRollRequested;
    }
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_IS_MFA_COMPLETE, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_IS_MFA_REQUIRED, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_EXPIRATION_SECONDS, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.links, currentApiSessionDetail.links)
                ...
                && Objects.equals(
                        this.improperClientCertChain,
                        currentApiSessionDetail.improperClientCertChain)
                && Objects.equals(this.ipAddress, currentApiSessionDetail.ipAddress)
                && Objects.equals(
                        this.isCertExtendRequested, currentApiSessionDetail.isCertExtendRequested)
                && Objects.equals(this.isCertExtendable, currentApiSessionDetail.isCertExtendable)
                && Objects.equals(
                        this.isCertKeyRollRequested, currentApiSessionDetail.isCertKeyRollRequested)
    ...
    public String toString() {
        ...
        sb.append("    improperClientCertChain: ")
                .append(toIndentedString(improperClientCertChain))
                .append("\n");
        sb.append("    ipAddress: ").append(toIndentedString(ipAddress)).append("\n");
        sb.append("    isCertExtendRequested: ")
                .append(toIndentedString(isCertExtendRequested))
                .append("\n");
        sb.append("    isCertExtendable: ").append(toIndentedString(isCertExtendable)).append("\n");
        sb.append("    isCertKeyRollRequested: ")
                .append(toIndentedString(isCertKeyRollRequested))
                .append("\n");
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getAuthenticatorId() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getAuthenticatorId()))));
        }
        ...
        // add `improperClientCertChain` to the URL query string
        if (getImproperClientCertChain() != null) {
            joiner.add(
                    String.format(
                            java.util.Locale.ROOT,
                            "%simproperClientCertChain%s=%s",
                            prefix,
                            suffix,
                            ApiClient.urlEncode(
                                    ApiClient.valueToString(getImproperClientCertChain()))));
        }
        ...
        if (getIpAddress() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getIpAddress()))));
        }

        // add `isCertExtendRequested` to the URL query string
        if (getIsCertExtendRequested() != null) {
            joiner.add(
                    String.format(
                            java.util.Locale.ROOT,
                            "%sisCertExtendRequested%s=%s",
                            prefix,
                            suffix,
                            ApiClient.urlEncode(
                                    ApiClient.valueToString(getIsCertExtendRequested()))));
        }
        ...
        if (getIsCertExtendable() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getIsCertExtendable()))));
        }

        // add `isCertKeyRollRequested` to the URL query string
        if (getIsCertKeyRollRequested() != null) {
            joiner.add(
                    String.format(
                            java.util.Locale.ROOT,
                            "%sisCertKeyRollRequested%s=%s",
                            prefix,
                            suffix,
                            ApiClient.urlEncode(
                                    ApiClient.valueToString(getIsCertKeyRollRequested()))));
        }
        ...
        if (getIsMfaComplete() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getIsMfaComplete()))));
        }
        ...
        if (getIsMfaRequired() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getIsMfaRequired()))));
        }
        ...
        if (getLastActivityAt() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getLastActivityAt()))));
        }
        ...
        if (getExpirationSeconds() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getExpirationSeconds()))));
        }
