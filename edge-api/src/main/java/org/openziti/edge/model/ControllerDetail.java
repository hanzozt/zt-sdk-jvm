...
public class ControllerDetail {
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_API_ADDRESSES, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonProperty(value = JSON_PROPERTY_CTRL_ADDRESS, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_LAST_JOINED_AT, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
