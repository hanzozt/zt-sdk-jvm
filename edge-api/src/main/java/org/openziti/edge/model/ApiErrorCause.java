...
public class ApiErrorCause {
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_CAUSE_MESSAGE, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        if (getField() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getField()))));
        }
        ...
        if (getCauseMessage() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getCauseMessage()))));
        }
