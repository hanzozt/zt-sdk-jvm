...
public class ListServiceEdgeRoutersEnvelope {
    ...
    @javax.annotation.Nonnull private ServiceEdgeRouters data;
    ...
    public ListServiceEdgeRoutersEnvelope data(@javax.annotation.Nonnull ServiceEdgeRouters data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setData(@javax.annotation.Nonnull ServiceEdgeRouters data) {
        this.data = data;
    }

    public ListServiceEdgeRoutersEnvelope meta(@javax.annotation.Nonnull Meta meta) {
        this.meta = meta;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        ListServiceEdgeRoutersEnvelope listServiceEdgeRoutersEnvelope =
                (ListServiceEdgeRoutersEnvelope) o;
