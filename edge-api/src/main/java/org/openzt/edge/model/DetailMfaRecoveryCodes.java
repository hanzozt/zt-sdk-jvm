...
public class DetailMfaRecoveryCodes {
    ...
    @javax.annotation.Nonnull private List<String> recoveryCodes = new ArrayList<>();

    public DetailMfaRecoveryCodes() {}

    public DetailMfaRecoveryCodes links(@javax.annotation.Nonnull Map<String, Link> links) {
        this.links = links;
        return this;
    }
    ...
    public DetailMfaRecoveryCodes createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
    ...
    public DetailMfaRecoveryCodes id(@javax.annotation.Nonnull String id) {
        this.id = id;
        return this;
    }
    ...
    public DetailMfaRecoveryCodes tags(@javax.annotation.Nullable Tags tags) {
        this.tags = tags;
        return this;
    }
    ...
    public DetailMfaRecoveryCodes updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
    ...
    public DetailMfaRecoveryCodes recoveryCodes(
            @javax.annotation.Nonnull List<String> recoveryCodes) {
     ...
     */
    @javax.annotation.Nonnull
    @JsonProperty(value = JSON_PROPERTY_RECOVERY_CODES, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    ...
    @JsonProperty(value = JSON_PROPERTY_RECOVERY_CODES, required = true)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setRecoveryCodes(@javax.annotation.Nonnull List<String> recoveryCodes) {
        this.recoveryCodes = recoveryCodes;
    }
