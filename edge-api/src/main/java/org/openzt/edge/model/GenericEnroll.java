...
public class GenericEnroll {
    ...
    @JsonProperty(value = JSON_PROPERTY_CERT_CSR, required = false)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_CLIENT_CSR, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_SERVER_CERT_CSR, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
