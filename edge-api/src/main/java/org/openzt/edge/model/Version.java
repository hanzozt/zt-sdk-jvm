...
public class Version {
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_API_VERSIONS, required = false)
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_RUNTIME_VERSION, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        if (getRuntimeVersion() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getRuntimeVersion()))));
        }
