...
public class DetailMfa {
    ...
    @javax.annotation.Nullable private String provisioningUrl;

    public static final String JSON_PROPERTY_RECOVERY_CODES = "recoveryCodes";
    @javax.annotation.Nullable private List<String> recoveryCodes = new ArrayList<>();

    public DetailMfa() {}

    public DetailMfa links(@javax.annotation.Nonnull Map<String, Link> links) {
        this.links = links;
        return this;
    }
    ...
    public DetailMfa createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
    ...
    public DetailMfa id(@javax.annotation.Nonnull String id) {
        this.id = id;
        return this;
    }
    ...
    public DetailMfa tags(@javax.annotation.Nullable Tags tags) {
        this.tags = tags;
        return this;
    }
    ...
    public DetailMfa updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
    ...
    public DetailMfa isVerified(@javax.annotation.Nonnull Boolean isVerified) {
    ...
    public DetailMfa provisioningUrl(@javax.annotation.Nullable String provisioningUrl) {
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_PROVISIONING_URL, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public DetailMfa recoveryCodes(@javax.annotation.Nullable List<String> recoveryCodes) {
     ...
     */
    @javax.annotation.Nullable
    @JsonProperty(value = JSON_PROPERTY_RECOVERY_CODES, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        if (getProvisioningUrl() != null) {
            joiner.add(
                    String.format(
                            ...
                            prefix,
                            suffix,
                            ApiClient.urlEncode(ApiClient.valueToString(getProvisioningUrl()))));
        }
