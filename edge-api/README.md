...
Hanzo ZT Edge Client API
  ...
  For more information, please visit [https://hanzozt.discourse.group](https://hanzozt.discourse.group)
...
```groovy
compile "org.hanzozt:edge-api:0.31.2-bump-edge-api-8.fea3ec8-dirty-SNAPSHOT"
```
