...
To run the sample application you need a service with an intercept. Under Additional Links there is a link to ZEDS or you can run the zt-spring-boot sample.
...
* Ziti Spring Server [sample](../zt-spring-boot)
