 ...
 */
package org.hanzozt.sample.springboot.client;
...
public class RestSampleCaller {
  ...
  @Autowired
  public RestSampleCaller(@Qualifier("ztRestTemplate") RestTemplate restTemplate, @Qualifier("ztRestClient") RestClient restClient) {
  ...
  public void call() {
    final String url = "http://whatismyip.zt/";
//    final String url = "https://whatismyip.zt/";
//    final String url = "https://eth0.me";
//    final String url = "https://local.zt";
