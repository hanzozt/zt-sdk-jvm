# Postgresql Example
This project contains a simple java application that uses the [Hanzo ZT](https://hanzozt.github.io/ziti/overview.html) Java SDK to connect to a [Postgresql](https://www.postgresql.org/) database and read the contents of a table.
